---
title: 'Hacıyatmazı Devirmek: Neoliberal Pratiklere Karşı Kolektivite'
lang: tr
description: 'Eser Adı: Hacıyatmazı Devirmek: Neoliberal Pratiklere Karşı Kolektivite Katkım: “POAŞ’ın Özelleştirilmesi ve Kâr Merkezli Bir Yönetimin Sorgulanması” bölümü (s. 321-354) Yayına…'
topics:
  - emek-isci-haklari
year: 2010
kitapTuru: katkılar
...
Kitaba katkım olan bölümde, Petrol Ofisi'nin (POAŞ) özelleştirilme sürecini ve özelleştirme sonrasında kurumda hâkim hale gelen "kâr merkezli" yönetim anlayışını inceliyorum. Bölüm, özelleştirme yazınının genellikle gözden kaçırdığı bir soruyu merkeze alıyor: Bir kurum kamu ya da özel mülkiyette olmaktan bağımsız olarak, "kâr" ve "kişisel/siyasal çıkar" öncelikli bir yönetim anlayışıyla yönetildiğinde bundan en çok kimler etkileniyor? Bu soruyu, POAŞ çalışanları ve Petrol-İş Sendikası ile yapılan görüşmeler üzerinden tartışıyorum.

Kapak görselleri ve yazı içeriği yalnızca yazarın kendi bölümüne ait telif hakkı çerçevesinde, kitabın tanıtımı amacıyla paylaşılmaktadır.
