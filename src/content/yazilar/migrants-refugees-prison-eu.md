---
title: To Be a Migrant, Refugee, Asylum Seeker, and Prisoner in EU Countries
lang: en
description: This is the English translation of an article first published in Turkish in 2021. The text examines the disproportionate incarceration of migrants, refugees,…
topics:
  - multecilik
  - kriminalizasyon
...
If we include Türkiye in this picture, it ranks as the second country where the imprisonment rate of migrants and asylum seekers compared to its own citizens is the lowest. There are three main reasons why the imprisonment rate of foreigners is so low in Türkiye:[\[v\]](#_edn5)

*   Compared to European countries, the issue of mass and permanent migration is still relatively new in Türkiye.
*   Apart from the recent waves of migration from Syria, Türkiye is generally considered a transit country for migrants, refugees, and asylum seekers rather than a final destination.
*   A significant number of foreigners in Türkiye are “undocumented,” and their information is not entered into the system.
...
[\[i\]](#_ednref1) This article was written solely to highlight a particular issue — namely, that migrants, refugees, and asylum seekers in EU member states are incarcerated at a rate four times higher than that of citizens of those states. It serves as an introductory analysis. It is possible to deepen the subject further by examining the issue starting from the detention phase, comparing durations of pre-trial detention, considering the countries of origin of migrants, refugees, and prisoners, and conducting in-depth interviews to develop a qualitative study.

[\[ii\]](#_ednref2) The data is sourced from Eurostat, the statistical office of the European Union:  
[https://ec.europa.eu/eurostat/statistics-explained/index.php?title=File:Non-national\_population\_by\_group\_of\_citizenship,\_1\_January\_2020.png#file](https://ec.europa.eu/eurostat/statistics-explained/index.php?title=File:Non-national_population_by_group_of_citizenship,_1_January_2020.png#file)  
Eurostat provides data for 27 EU member states as well as Iceland, Liechtenstein, Norway, and Switzerland. In the remainder of the article, the phrase “EU member states” will be used instead of “27 EU member states and 4 other European countries.”  
In the tables and graphs, data from Türkiye is also included to allow for comparison alongside EU member states.

[\[iii\]](#_ednref3) The data on the number of prisoners and the proportion of foreign prisoners in EU countries is sourced from the Council of Europe Annual Penal Statistics report, known as SPACE I.  
[https://wp.unil.ch/space/files/2021/04/210330\_FinalReport\_SPACE\_I\_2020.pdf](https://wp.unil.ch/space/files/2021/04/210330_FinalReport_SPACE_I_2020.pdf)

[\[iv\]](#_ednref4) In the data presented in the Council of Europe’s SPACE I/2020 report, there were omissions in the statistics for Cyprus, Germany, and Sweden. For Cyprus, while the total number of prisoners and the number of domestic prisoners were provided, the number of foreign prisoners was left blank. In this case, the number of domestic prisoners was subtracted from the total to estimate the number of foreign prisoners. For Germany and Sweden, the number of foreign detainees was not reported, so only the number of convicted foreign prisoners was considered as the total number of foreign prisoners. As a result, it is possible to say that the foreign prisoner figures for Germany and Sweden are slightly underestimated due to the absence of data on pre-trial detainees in the Council of Europe publication.
